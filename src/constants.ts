...
export const BIBLE_TRANSLATIONS = [
  ...
  { id: 'OEB-US', name: 'Open English Bible (US)', isNTOnly: true },
  { id: 'OEB-CW', name: 'Open English Bible (CW)', isNTOnly: true },
  { id: 'YLT', name: "Young's Literal Translation", isNTOnly: true },
...
export const HIGHLIGHT_COLORS = [
  ...
  { id: 'none', value: 'transparent', label: 'Clear' }
];
